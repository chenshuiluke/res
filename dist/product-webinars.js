...
var $905c9fcb73b2cbd0$var$e = (0, (/*@__PURE__*/$parcel$interopDefault($aa7d2))).createElement;
var $905c9fcb73b2cbd0$var$useState = (0, (/*@__PURE__*/$parcel$interopDefault($aa7d2))).useState;
var $905c9fcb73b2cbd0$var$useEffect = (0, (/*@__PURE__*/$parcel$interopDefault($aa7d2))).useEffect;
var $905c9fcb73b2cbd0$var$$;
window.selectedTags = [];
window.selectedContent = [];
window.selectedDesiredOutcomes = [];
var $905c9fcb73b2cbd0$var$ProductWebinars = function(param) {
    var scrollPosition = param.scrollPosition;
    var _useState = (0, $b246210675339a3d$export$fdf2a89c76341bbf)($905c9fcb73b2cbd0$var$useState([]), 2), blogs = _useState[0], setBlogs = _useState[1];
    var _useState1 = (0, $b246210675339a3d$export$fdf2a89c76341bbf)($905c9fcb73b2cbd0$var$useState([]), 2), podcasts = _useState1[0], setPodcasts = _useState1[1];
    var _useState2 = (0, $b246210675339a3d$export$fdf2a89c76341bbf)($905c9fcb73b2cbd0$var$useState([]), 2), webinars = _useState2[0], setWebinars = _useState2[1];
    var _useState3 = (0, $b246210675339a3d$export$fdf2a89c76341bbf)($905c9fcb73b2cbd0$var$useState([]), 2), ebooks = _useState3[0], setEbooks = _useState3[1];
    var _useState4 = (0, $b246210675339a3d$export$fdf2a89c76341bbf)($905c9fcb73b2cbd0$var$useState([]), 2), testimonials = _useState4[0], setTestimonials = _useState4[1];
    var _useState5 = (0, $b246210675339a3d$export$fdf2a89c76341bbf)($905c9fcb73b2cbd0$var$useState(3), 2), blogLimit = _useState5[0], setBlogLimit = _useState5[1];
    var _useState6 = (0, $b246210675339a3d$export$fdf2a89c76341bbf)($905c9fcb73b2cbd0$var$useState(3), 2), podcastLimit = _useState6[0], setPodcastLimit = _useState6[1];
    var _useState7 = (0, $b246210675339a3d$export$fdf2a89c76341bbf)($905c9fcb73b2cbd0$var$useState(3), 2), webinarLimit = _useState7[0], setWebinarLimit = _useState7[1];
    var _useState8 = (0, $b246210675339a3d$export$fdf2a89c76341bbf)($905c9fcb73b2cbd0$var$useState(3), 2), ebookLimit = _useState8[0], setEbooksLimit = _useState8[1];
    var _useState9 = (0, $b246210675339a3d$export$fdf2a89c76341bbf)($905c9fcb73b2cbd0$var$useState(3), 2), testimonialLimit = _useState9[0], setTestimonialLimit = _useState9[1];
    var _useState10 = (0, $b246210675339a3d$export$fdf2a89c76341bbf)($905c9fcb73b2cbd0$var$useState([]), 2), tags = _useState10[0], setTags = _useState10[1];
    var _useState11 = (0, $b246210675339a3d$export$fdf2a89c76341bbf)($905c9fcb73b2cbd0$var$useState([]), 2), contentTypes = _useState11[0], setContentTypes = _useState11[1];
    var _useState12 = (0, $b246210675339a3d$export$fdf2a89c76341bbf)($905c9fcb73b2cbd0$var$useState(""), 2), searchFilter = _useState12[0], setSearchFilter = _useState12[1];
    var _useState13 = (0, $b246210675339a3d$export$fdf2a89c76341bbf)($905c9fcb73b2cbd0$var$useState([]), 2), apiDesiredOutcomes = _useState13[0], setApiDesiredOutcomes = _useState13[1];
    var _useState14 = (0, $b246210675339a3d$export$fdf2a89c76341bbf)($905c9fcb73b2cbd0$var$useState([]), 2), desiredOutcomes = _useState14[0], setDesiredOutcomes = _useState14[1];
    var _useState15 = (0, $b246210675339a3d$export$fdf2a89c76341bbf)($905c9fcb73b2cbd0$var$useState({}), 2), apiTags = _useState15[0], setApiTags = _useState15[1];
    var _useState16 = (0, $b246210675339a3d$export$fdf2a89c76341bbf)($905c9fcb73b2cbd0$var$useState([]), 2), allCards = _useState16[0], setAllCards = _useState16[1];
    var _useState17 = (0, $b246210675339a3d$export$fdf2a89c76341bbf)($905c9fcb73b2cbd0$var$useState(6), 2), limit = _useState17[0], setLimit = _useState17[1];
    var generateGuid = function() {
        return Math.random().toString(36).substring(2, 15) + Math.random().toString(36).substring(2, 15);
    };
    $905c9fcb73b2cbd0$var$useEffect(function() {
    ...
    var getDesiredOutcomesFromApi = function() {
        var _ref = (0, $100020652c8ec3fa$export$7c398597f8905a1)(function() {
            var response, data;
            return (0, $39285b8110379890$export$67ebef60e6f28a6)(this, function(_state) {
                switch(_state.label){
                    case 0:
                        return [
                            4,
                            fetch("https://di-marketing-server-iuzlr.ondigitalocean.app/api/desired-outcomes")
                        ];
                    case 1:
        ...
        return function getDesiredOutcomesFromApi() {
            return _ref.apply(this, arguments);
        };
    }();
    ...
    $905c9fcb73b2cbd0$var$useEffect(/*#__PURE__*/ (0, $100020652c8ec3fa$export$7c398597f8905a1)(function() {
        ...
        return (0, $39285b8110379890$export$67ebef60e6f28a6)(this, function(_state) {
            switch(_state.label){
                case 0:
                    return [
                        4,
                        fetch("https://di-marketing-server-iuzlr.ondigitalocean.app/api/product-webinars")
                    ];
                case 1:
                    response = _state.sent();
                    return [
    ...
    $905c9fcb73b2cbd0$var$useEffect(function() {
        getDesiredOutcomesFromApi().then(function(apiDesiredOutcomes) {
            var waitForJQuery = setInterval(function() {
                if (typeof window.$ != "undefined") {
                    $905c9fcb73b2cbd0$var$$ = window.$;
                    ...
                    window.eventBus.on("checked", function(tag, checked) {
                        ...
                        var desiredOutcomeArr = (0, $f7056d2783c1f20d$export$1b5e630bc3aea29f)(window.selectedDesiredOutcomes);
                        var contentTags = [
                            "analytics",
                            "engagement",
                            "insurance",
                        ...
                        if (apiDesiredOutcomes.includes(tag.toLowerCase())) {
                            if (checked) {
                                if (!desiredOutcomeArr.includes(tag.toLowerCase())) desiredOutcomeArr.push(tag.toLowerCase());
                            } else if (desiredOutcomeArr.includes(tag.toLowerCase())) desiredOutcomeArr = desiredOutcomeArr.filter(function(element) {
                                return element != tag.toLowerCase();
                            });
                            setDesiredOutcomes((0, $f7056d2783c1f20d$export$1b5e630bc3aea29f)(desiredOutcomeArr));
                    ...
                    $905c9fcb73b2cbd0$var$$(".w-checkbox.tag.blog.new input").change(function() {
                        debugger;
                        var tags = $905c9fcb73b2cbd0$var$$(this).siblings("span").text();
                        window.eventBus.emit("checked", null, tags, this.checked);
                    });
                    $905c9fcb73b2cbd0$var$$(".search-input-new.w-input").keyup(function(event) {
                        var text = $905c9fcb73b2cbd0$var$$(this).val();
                        setSearchFilter(text);
                    });
                    $905c9fcb73b2cbd0$var$$(".search-input-new.w-input").focusout(function() {
                        var text = $905c9fcb73b2cbd0$var$$(this).val();
                        setSearchFilter(text);
                    });
                }
    ...
    var renderBlog = function(blog) {
        return /*#__PURE__*/ (0, $bdf85e2bddd128c1$exports.jsx)("div", {
            role: "listitem",
            ...
            children: /*#__PURE__*/ (0, $bdf85e2bddd128c1$exports.jsxs)("a", {
                ...
                children: [
                    /*#__PURE__*/ (0, $bdf85e2bddd128c1$exports.jsx)("div", {
                        class: "blog-img-wrap",
                        children: /*#__PURE__*/ (0, $bdf85e2bddd128c1$exports.jsx)((0, $f8ddc0ba680638dd$exports.LazyLoadImage), {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, $bdf85e2bddd128c1$exports.jsxs)("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, $bdf85e2bddd128c1$exports.jsxs)("p", {
                                        "fs-cmsfilter-field": "author",
                                        class: "paragraph blog blog-author",
                                        children: [
                                            "Ep. #",
    ...
    var renderWebinar = function(webinar) {
        var _webinar_module_toLowerCase_split, _webinar_module_toLowerCase, _webinar_module, _webinar_module_toLowerCase1, _webinar_module1;
        var className = "pill-label";
        var colorClass = "";
        var webinarModules = [];
        var firstModule = (_webinar_module_toLowerCase_split = (_webinar_module_toLowerCase = (_webinar_module = webinar.module) === null || _webinar_module === void 0 ? void 0 : _webinar_module.toLowerCase()) === null || _webinar_module_toLowerCase === void 0 ? void 0 : _webinar_module_toLowerCase.split(" ")) === null || _webinar_module_toLowerCase_split === void 0 ? void 0 : _webinar_module_toLowerCase_split[0];
        if (firstModule == "monthly") firstModule = "monthly product webinar";
        var possibleModuleValues = [
            "engagement",
            "analytics",
            "localmed",
            "monthly product webinar",
        ...
        try {
            for(var _iterator = possibleModuleValues[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true){
                var possibleValue = _step.value;
                if ((_webinar_module_toLowerCase1 = (_webinar_module1 = webinar.module) === null || _webinar_module1 === void 0 ? void 0 : _webinar_module1.toLowerCase()) === null || _webinar_module_toLowerCase1 === void 0 ? void 0 : _webinar_module_toLowerCase1.includes(possibleValue)) {
                    var colorClass1 = "";
                    ...
                    var moduleName = possibleValue.split(" ").map(function(word) {
        ...
        var words = firstModule.split(" ");
        var moduleName1 = "";
        if (webinar.module == "localmed") moduleName1 = "LocalMed";
        else moduleName1 = words.map(function(word) {
            return word[0].toUpperCase() + word.substring(1);
        }).join(" ");
        return /*#__PURE__*/ (0, $bdf85e2bddd128c1$exports.jsx)("div", {
            role: "listitem",
            ...
            children: /*#__PURE__*/ (0, $bdf85e2bddd128c1$exports.jsxs)("a", {
                ...
                children: [
                    ...
                    webinarModules.map(function(param) {
                        var colorClass = param.colorClass, moduleName = param.moduleName;
                        return /*#__PURE__*/ (0, $bdf85e2bddd128c1$exports.jsx)("div", {
                            class: "".concat(className, " ").concat(colorClass),
                            children: /*#__PURE__*/ (0, $bdf85e2bddd128c1$exports.jsx)("div", {
                                "fs-cmsfilter-field": "type",
                                class: "text-block-6",
                                children: moduleName
            ...
            children: /*#__PURE__*/ (0, $bdf85e2bddd128c1$exports.jsxs)("div", {
                ...
                children: [
                    allCards.filter(function(card) {
                        ...
                        if (desiredOutcomes.length == 0) return true;
                        var _iteratorNormalCompletion = true, _didIteratorError = false, _iteratorError = undefined;
                        try {
                            for(var _iterator = desiredOutcomes[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true){
                                var desiredOutcome = _step.value;
                                var _card_desiredOutcomes;
                                if (!(card === null || card === void 0 ? void 0 : (_card_desiredOutcomes = card.desiredOutcomes) === null || _card_desiredOutcomes === void 0 ? void 0 : _card_desiredOutcomes.includes(desiredOutcome))) return false;
                            }
                        } catch (err) {
                            _didIteratorError = true;
                            _iteratorError = err;
                        ...
                        if (contentTypes.length > 0 || tags.length > 0 || searchFilter.length > 0 || desiredOutcomes.length > 0) return true;
                        return idx < limit;
                    }).map(function(card) {
                        var content = null;
                        if (contentTypes.length == 0) content = renderWebinar(card);
                        else {
                            var _card_module_toLowerCase, _card_module;
                            var _iteratorNormalCompletion = true, _didIteratorError = false, _iteratorError = undefined;
                            try {
                                for(var _iterator = contentTypes[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true){
                                    var module = _step.value;
                                    if ((_card_module_toLowerCase = card === null || card === void 0 ? void 0 : (_card_module = card.module) === null || _card_module === void 0 ? void 0 : _card_module.toLowerCase()) === null || _card_module_toLowerCase === void 0 ? void 0 : _card_module_toLowerCase.includes(module === null || module === void 0 ? void 0 : module.toLowerCase())) {
                    ...
                    tags.length == 0 && contentTypes.length == 0 && searchFilter.length == 0 && desiredOutcomes.length == 0 && /*#__PURE__*/ (0, $bdf85e2bddd128c1$exports.jsx)((0, $bdf85e2bddd128c1$exports.Fragment), {
                        children: /*#__PURE__*/ (0, $bdf85e2bddd128c1$exports.jsx)("div", {
...
var $905c9fcb73b2cbd0$var$component = (0, $f8ddc0ba680638dd$exports.trackWindowScroll)($905c9fcb73b2cbd0$var$ProductWebinars);
var $905c9fcb73b2cbd0$var$domContainer = document.querySelector("#root");
var $905c9fcb73b2cbd0$var$root = (0, (/*@__PURE__*/$parcel$interopDefault($fupsZ))).createRoot($905c9fcb73b2cbd0$var$domContainer);
$905c9fcb73b2cbd0$var$root.render($905c9fcb73b2cbd0$var$e($905c9fcb73b2cbd0$var$component));

})();
//# sourceMappingURL=product-webinars.js.map
