...
var $070841a0d032b268$var$e = (0, (/*@__PURE__*/$parcel$interopDefault($aa7d2))).createElement;
var $070841a0d032b268$var$useState = (0, (/*@__PURE__*/$parcel$interopDefault($aa7d2))).useState;
var $070841a0d032b268$var$useEffect = (0, (/*@__PURE__*/$parcel$interopDefault($aa7d2))).useEffect;
var $070841a0d032b268$var$$;
window.selectedTags = [];
window.selectedContent = [];
var $070841a0d032b268$var$Partners = function() {
    var _useState = (0, $b246210675339a3d$export$fdf2a89c76341bbf)($070841a0d032b268$var$useState([]), 2), diamondPartners = _useState[0], setDiamondPartners = _useState[1];
    var _useState1 = (0, $b246210675339a3d$export$fdf2a89c76341bbf)($070841a0d032b268$var$useState([]), 2), goldPartners = _useState1[0], setGoldPartners = _useState1[1];
    var _useState2 = (0, $b246210675339a3d$export$fdf2a89c76341bbf)($070841a0d032b268$var$useState([]), 2), serviceTypeList = _useState2[0], setServiceTypeList = _useState2[1];
    var _useState3 = (0, $b246210675339a3d$export$fdf2a89c76341bbf)($070841a0d032b268$var$useState([]), 2), tags = _useState3[0], setTags = _useState3[1];
    var _useState4 = (0, $b246210675339a3d$export$fdf2a89c76341bbf)($070841a0d032b268$var$useState(""), 2), searchFilter = _useState4[0], setSearchFilter = _useState4[1];
    $070841a0d032b268$var$useEffect(/*#__PURE__*/ (0, $100020652c8ec3fa$export$7c398597f8905a1)(function() {
        var response, content, serviceTypeResponse, serviceTypeContent, serviceTypes;
        return (0, $39285b8110379890$export$67ebef60e6f28a6)(this, function(_state) {
            switch(_state.label){
                case 0:
                    return [
                        4,
                        fetch("https://di-marketing-server-iuzlr.ondigitalocean.app/api/certified-partners")
                    ];
                case 1:
                ...
                case 2:
                    ...
                    return [
                        4,
                        fetch("https://di-marketing-server-iuzlr.ondigitalocean.app/api/certified-partners/service-types")
                    ];
                case 3:
                    serviceTypeResponse = _state.sent();
                    return [
                        4,
                        serviceTypeResponse.json()
                    ];
                case 4:
                    serviceTypeContent = _state.sent();
                    serviceTypes = serviceTypeContent.serviceTypes;
                    if (serviceTypes != null && serviceTypes.length > 0) setServiceTypeList(serviceTypes.map(function(service) {
    ...
    $070841a0d032b268$var$useEffect(function() {
        var waitForJQuery = setInterval(function() {
            if (typeof window.$ != "undefined") {
                $070841a0d032b268$var$$ = window.$;
                ...
                $070841a0d032b268$var$$(".w-checkbox.tag.blog.new input").change(function() {
                    debugger;
                    var tags = $070841a0d032b268$var$$(this).siblings("span").text();
                    window.eventBus.emit("checked", null, tags, this.checked);
                });
                $070841a0d032b268$var$$(".search-input-new.w-input").keyup(function(event) {
                    var text = $070841a0d032b268$var$$(this).val();
                    setSearchFilter(text);
                });
                $070841a0d032b268$var$$(".search-input-new.w-input").focusout(function() {
                    var text = $070841a0d032b268$var$$(this).val();
                    setSearchFilter(text);
                });
                debugger;
    ...
    var filterPartnerBasedOnTag = function(partner) {
        if (tags.length == 0) return true;
        var _iteratorNormalCompletion = true, _didIteratorError = false, _iteratorError = undefined;
        try {
            for(var _iterator = tags[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true){
                var tag = _step.value;
                var _partner_services;
                if (!(partner === null || partner === void 0 ? void 0 : (_partner_services = partner.services) === null || _partner_services === void 0 ? void 0 : _partner_services.includes(tag))) return false;
            }
        } catch (err) {
    ...
    var filterPartnerBasedOnSearchInput = function(item) {
        try {
            if (searchFilter != "") {
    ...
    var renderDiamondPartner = function(partner) {
        return /*#__PURE__*/ (0, $bdf85e2bddd128c1$exports.jsx)((0, $bdf85e2bddd128c1$exports.Fragment), {
            children: /*#__PURE__*/ (0, $bdf85e2bddd128c1$exports.jsx)("a", {
                href: partner.link,
                style: {
                    textDecoration: "none"
                },
                    ...
                    children: [
                        /*#__PURE__*/ (0, $bdf85e2bddd128c1$exports.jsxs)("div", {
                            ...
                            children: [
                                ...
                                partner.isTopPerformer && /*#__PURE__*/ (0, $bdf85e2bddd128c1$exports.jsx)((0, $bdf85e2bddd128c1$exports.Fragment), {
                                    children: /*#__PURE__*/ (0, $bdf85e2bddd128c1$exports.jsxs)("div", {
                                        class: "div-block-60",
                                        children: [
                                            /*#__PURE__*/ (0, $bdf85e2bddd128c1$exports.jsx)("img", {
                                            ...
                                            /*#__PURE__*/ (0, $bdf85e2bddd128c1$exports.jsx)("div", {
                                                ...
                                                children: partner.topPerformerCategory
                                            })
                                        ]
                                    })
                                })
                        ...
                        /*#__PURE__*/ (0, $bdf85e2bddd128c1$exports.jsxs)("div", {
                            class: "partner-card-bottom",
                            children: [
                                /*#__PURE__*/ (0, $bdf85e2bddd128c1$exports.jsx)("div", {
                                    class: "paragraph certified-partner-card-sub"
                                }),
                                /*#__PURE__*/ (0, $bdf85e2bddd128c1$exports.jsx)("div", {
                                ...
                                /*#__PURE__*/ (0, $bdf85e2bddd128c1$exports.jsx)("div", {
                                    ...
                                    children: partner.description.slice(0, 200)
                                }),
                                /*#__PURE__*/ (0, $bdf85e2bddd128c1$exports.jsx)("div", {
                                    class: "card-btn-wrapper certified-partner",
                                    children: /*#__PURE__*/ (0, $bdf85e2bddd128c1$exports.jsx)("a", {
                                        href: partner.link,
    ...
    var renderDiamondPartners = function(diamondPartners) {
        return /*#__PURE__*/ (0, $bdf85e2bddd128c1$exports.jsx)((0, $bdf85e2bddd128c1$exports.Fragment), {
            children: /*#__PURE__*/ (0, $bdf85e2bddd128c1$exports.jsx)("div", {
                class: "w-layout-grid grid-17",
                children: diamondPartners.filter(filterPartnerBasedOnTag).filter(filterPartnerBasedOnSearchInput).map(function(partner) {
                    return renderDiamondPartner(partner);
                })
            })
        });
    };
    var renderGoldPartner = function(partner) {
        return /*#__PURE__*/ (0, $bdf85e2bddd128c1$exports.jsx)((0, $bdf85e2bddd128c1$exports.Fragment), {
            children: /*#__PURE__*/ (0, $bdf85e2bddd128c1$exports.jsx)("a", {
                href: partner.link,
                style: {
    ...
    var renderGoldPartners = function(goldPartners) {
        return /*#__PURE__*/ (0, $bdf85e2bddd128c1$exports.jsx)((0, $bdf85e2bddd128c1$exports.Fragment), {
            children: /*#__PURE__*/ (0, $bdf85e2bddd128c1$exports.jsx)("div", {
                class: "w-layout-grid grid-16",
                children: goldPartners.filter(filterPartnerBasedOnTag).filter(filterPartnerBasedOnSearchInput).map(function(partner) {
                    return renderGoldPartner(partner);
                })
            })
        });
    };
    return /*#__PURE__*/ (0, $bdf85e2bddd128c1$exports.jsxs)((0, $bdf85e2bddd128c1$exports.Fragment), {
        children: [
...
var $070841a0d032b268$var$component = (0, $f8ddc0ba680638dd$exports.trackWindowScroll)($070841a0d032b268$var$Partners);
var $070841a0d032b268$var$domContainer = document.querySelector("#root");
var $070841a0d032b268$var$root = (0, (/*@__PURE__*/$parcel$interopDefault($fupsZ))).createRoot($070841a0d032b268$var$domContainer);
$070841a0d032b268$var$root.render($070841a0d032b268$var$e($070841a0d032b268$var$component));
